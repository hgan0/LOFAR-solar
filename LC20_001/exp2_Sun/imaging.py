...
data_dir = "/net/zernike/scratch3/hgan/processed/" + obsvID + "_exp2/case1/"
...
for i in range(len(SB_Sun)):
    ...
    setting = "wsclean -j 40 -mem 80 -auto-mask 3 -auto-threshold 0.3 -fit-beam -make-psf -reorder " + \
             ...
             " -minuvw-m 500 -maxuvw-m 12000 -scale 20asec -pol I -niter 1500 -intervals-out 5 -interval 0 500"
    ...
    FITSnames = [FITSname0, FITSname3, ]
    MSnames = [MSname0, MSname3,  ]
    columns = [column_opt[1], column_opt[1],  ]
